...
AND OrderDate < CONVERT(DATE, DATEADD(DAY,1, GETDATE()));

INSERT INTO [NorthwindDW].[dbo].[Order Details]
...
ON od.OrderID = o.OrderID WHERE OrderDate >= CONVERT(DATE, GETDATE()) AND 
